...
⪼ Dᴇᴠᴇʟᴏᴘᴇʀ 1: <a href='https://t.me/Hacker_Jr'>HᴀᴄKᴇʀ Jʀ</a>
⪼ Dᴇᴠᴇʟᴏᴘᴇʀ 2: <a href='https://t.me/blesson_3'>Mʀ Mᴀᴋʀɪ</a>
...
⪼ Bᴜʟʟᴅ Sᴛᴀᴛᴜs: <code>ᴠ1.0.1 [ Bᴇᴛᴀ ]</code></b>"""
    ...
    SOURCE_TXT = """<b>Hey {message.from_user.mention},

If You Want To Get The Requested Movies You Have To Join The Main Channel Given Below.✌️😚✨

ചോദിക്കുന്ന സിനിമകൾ നിങ്ങൾക്ക് ലഭിക്കണം എന്നുണ്ടെങ്കിൽ നിങ്ങൾ താഴെ കൊടുത്തിട്ടുള്ള Main Channel ജോയിൻ ചെയ്യണം.✌️😚✨</b>"""
